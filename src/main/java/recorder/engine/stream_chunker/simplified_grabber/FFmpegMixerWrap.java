...
public class FFmpegMixerWrap implements SimplifiedGrabber {
    ...
    private avcodec.AVPacket avPacket = null;
    ...
    public avcodec.AVPacket grabPacket() throws FrameGrabber.Exception {
        ...
        Future<avcodec.AVPacket> vf = null;
        if (avPacket == null) {
            vf = dualExecutor.submit(() -> {
                avcodec.AVPacket packet = videoGrabber.grabPacket();
//                packet.timestamp = videoGrabber.getTimestamp();
                return packet;
            });
        }
        try {
        ...
        avcodec.AVPacket packetToReturn;
        packetToReturn = avPacket;
        avPacket = null;
    ...
    public avformat.AVFormatContext getFormatContext() {
        return this.videoGrabber.getFormatContext();
    }
    ...
    @Override
    public int getFps() {
        return (int) this.videoGrabber.getFrameRate();
    }
